...
<section class="products">
   ...
   <div class="box-container">
      ...
      <?php
         $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE id BETWEEN 73 AND 96") or die('query failed');
   ...
   <br><br><br>
    ...
    <div class="model">
        <center>
            <table>
                <td><a href="shop3.php">Anterior</a></td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><a href="shop5.php">Siguiente</a></td>
            </table>
        </center>
    </div>
</section>
